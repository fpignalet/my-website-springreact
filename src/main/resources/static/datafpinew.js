module.exports = {
    ...
    "data_BNcontent9": {
        ...
        "blog_entry9CONTENT": [
            ...
            [ "ul",
                [
                    "Now the refactoring of my Resume/CV is over. Data are no longer stuck directly inside html code, but stored in a specific file. I do an Httprequest to get the content of the file from the server. Next steps are to finish normalize data format (the javascript parsing code is a little bit too hectic) Then apply the same refactoring to the whole site, and finally optimize data loading (ther is certainly too many Http requests)"
                ]
            ],
            ...
            [ "ul",
                [
                    ...
                    "The “between” training sessions (until “hard” FC threshold) allows to make a link between the httpext2 two types of training sessions. It allows to prepare the transition between the two half-marathon. This is the part of the training that allows you to learn to \"jump\" over the wall, finding an easy passage.",
    ...
    "data_BNcontent1": {
        ...
        "blog_entry1CONTENT":
            [
                [ "p",
                    [
                        "Voila, c'est parti... Je mets le site en ligne pour la premiere fois. Toujours pas de www actif pour le moment dans mon DNS, sais pas pourquoi :("
                    ]
                ]
            ]
                            ...
                            [
                                [ "Beschreibung", "Frontend und Embedded Software für folgende Produkte (IFF Interrogators und Transponder-Tools)",
                                    [
                                        ...
                                        [ "https://www.hensoldt.net/solutions/sea/identification-iff/military-mode-5-and-mode-s-interrogator-mssr-2000-i/", "... and httpext2 projects related with" ]
                                    ]
                                ],
                                [ "Umgebung",
                                    "Entwicklung auf Windows 7 und Linux Debian 8 mit Eclipse. C Embedded-Software, Java Rich-Client mit Swing-GUI, XML-Daten und Ant-Bereitstellung. Unit-Tests mit JUnit. Technologieumfrage: Javascript (AJAX), jQuery, React, Node, JSON. Organisation: JIRA, SVN, SW-Anforderungen in DOORS. Verschiedene Com-Links und spezielle HW:",
                                    [
                                        "UDP/TCP IP",
                                        "RS-XXX",
                                        [ "https://en.wikipedia.org/wiki/Automatic_dependent_surveillance_%E2%80%93_broadcast", "ADS-B" ],
                            ...
                            [
                                [ "Beschreibung",
                                    [
                                        ...
                                        "Design und Implementierung eines mehrstufigen 3-Tier-Architektur-Frontends mit umfassender Verwendung von Entwurfsmustern: Creational (Abstract Factory / Builder / Factory method / Object pool / Singleton), Structural (Bridge / Facade), Behavioral (Command / Iterator / State), Concurrency (Scheduler). Entwurf und Implementierung eines WebLogic-Backends mit PostgreSQL + geografischem Plugin"
                                    ]
                                ],
                                [ "Umgebung",
