...
class ReactDisclosable extends React.Component {
    ...
    renderCollapse() {
        ...
        return (
            <ReactBStrap.Collapse in={this.state.open}>
                <div id={this.ctlname}>
                    { this.text[this.titleentry] }
                    { this.text[this.textentry] }
                    <div id={ nextid }></div>
                </div>
    ...
    addSub(){
        ...
        const subindex = this.index + 1;
        ReactDOM.render(
            <ReactDisclosable
                data={ document }
                text={ this.text[this.textsubentry] }
                index={ subindex }
            /> ,
            container);
    }
...
class TestApp extends React.Component {
    ...
    renderdiscosable() {
        return (
            <ReactDisclosable
                data={document}
                text={jsondata["collapsable-text"]}
                index={1}
            />
        );
    }
